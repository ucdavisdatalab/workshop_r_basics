...
url: "https://ucdavisdatalab.github.io/workshop_r-basics/"
  ...
  bookdown::gitbook:
    config:
      toc:
        ...
        collapse: section
      sharing: no
      view: https://github.com/ucdavisdatalab/workshop_r-basics/blob/master/%s
      edit: https://github.com/ucdavisdatalab/workshop_r-basics/edit/master/%s
---
