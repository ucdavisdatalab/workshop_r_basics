...
* Run some code if a condition is satified with an if-statement
* Write functions to make code reusable
* Run some code repeatedly with a for-loop
* Describe differences between types of loops and how to choose
